...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__account_account__ = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__public_public__ = __webpack_require__(105);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__pages_public_public__ = __webpack_require__(105);
...
var MainPage = /** @class */ (function () {
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        ...
                        _this.SendForm(data.name, data.phone, id);
                    }
                },
                {
                    text: 'Отмена'
    ...
    MainPage.prototype.SendForm = function (name, phone, id) {
        var res;
        this.http.get("http://test9.superresheba.by/project/Egor/Form.php?name=" + name + "&phone=" + phone + "&id=" + id)
            .map(function (res) { return res.json(); })
            .subscribe(function (Arr) {
